<footer class="bg-morocco.ivory">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
            <div class="px-5 py-2">
                <a href="{{ url('/about') }}" class="text-base text-morocco.blue hover:text-morocco.red">
                    About
                </a>
            </div>
            <div class="px-5 py-2">
                <a href="{{ url('/blog') }}" class="text-base text-morocco.blue hover:text-morocco.red">
                    Blog
                </a>
            </div>
            <div class="px-5 py-2">
                <a href="{{ url('/contact') }}" class="text-base text-morocco.blue hover:text-morocco.red">
                    Contact
                </a>
            </div>
            <div class="px-5 py-2">
                <a href="{{ url('/privacy') }}" class="text-base text-morocco.blue hover:text-morocco.red">
                    Privacy Policy
                </a>
            </div>
            <div class="px-5 py-2">
                <a href="{{ url('/terms') }}" class="text-base text-morocco.blue hover:text-morocco.red">
                    Terms of Service
                </a>
            </div>
        </nav>
        <div class="mt-8 flex justify-center space-x-6">
            <a href="#" class="text-morocco.green hover:text-morocco.red">
        ...
        <p class="mt-8 text-center text-base text-morocco.blue">
